        ...
        try:
            ...
            for stock in subPortfolio:
                ...
                try:
                    ...
                    # df_1d.to_csv("/root/AkashMockAlgo/BLSLH50_V9/df_1d_with_rsi.csv")
                except Exception as e:
                ...
                try:
                    ...
                    # df_weekly.to_csv("/root/AkashMockAlgo/BLSLH50_V9/df_weekly_with_rsi.csv")
                except Exception as e:
...
class algoLogic:
    def mainLogic(self, mpName):
        try:
            ...
            baseDir = config.get('inputParameters', f'baseDir')

            fileDir = {
                "baseJson": f"{baseDir}/{algoName}/json",
                "openPositions": f"{baseDir}/{algoName}/json/OpenPositions",
                "closedPositions": f"{baseDir}/{algoName}/json/ClosedPositions",
                "baseLog": f"{baseDir}/{algoName}/logs",
                "strategyLogs": f"{baseDir}/{algoName}/logs/StrategyLog",
                "stockLogs": f"{baseDir}/{algoName}/logs/StrategyLog/Stocks",
                "jsonValue": f"{baseDir}/{algoName}/jsonss/jsonFiles"
            }
